"""argus, a simple monitoring tool.

:copyright: (c) 2013-2024 by Michiel Scholten.
...
@cli.command()
def rebooted():
    """Send a message about the node having rebooted."""
    message = (
...
@cli.command()
def node_info():
    """Provide information about this computer."""
